...
//box7 = new box(420,235,40,50);
  ...
  box15 = new box(390,275,30,40);
  //box16 = new box(390,235,40,50);
  console.log(box8.body.position.x)
  console.log(box9.body.position.x)
  console.log(box12.body.position.x)
  console.log(box13.body.position.x)
  console.log(box13.body.position.x)
  console.log(box14.body.position.x)
  //console.log(box15.body.position.x)
  //console.log(box16.body.position.x)
